...
import { EyesOnlyStamp } from "@/components/EyesOnlyStamp";
        ...
        <ParchmentPanel>
          ...
          <div className="text-center">
            ...
            <p className="font-courier text-[11px] tracking-[0.3em] uppercase text-[#8a5a22] mb-4">
              Father&rsquo;s Day 2026 &middot; Field Dossier
            </p>
          ...
          <div>
            ...
            <DropCap letter="I" className="font-inter text-[16.5px] leading-[1.75] text-[#3a2c19] mb-4">
              n the fourth year of Solomon&rsquo;s reign, his chief treasurer Hananiah 
              set aside a consecrated reserve — silver, gold, and sacred vessels — 
              beyond the official temple treasury, encoding its location in the cubit measurements 
              of 1 Kings 6 and passing the secret to a trusted line of Levites. 
              When Babylon sacked Jerusalem, the reserve didn&rsquo;t disappear — 
              it moved west, carried by exiled believers, partially recovered under Nehemiah, 
              and finally entrusted to a merchant woman in Philippi named Lydia. 
              She hid it again, encoding its location across fragments woven into her correspondence with Paul. 
              She called it <i>The Lord&rsquo;s Portion</i> — a stewardship, not a secret, 
              waiting for the right person in the right hour.
            </DropCap>
            <p className="font-inter text-[16.5px] leading-[1.75] text-[#3a2c19]">
              That hour is now. Three fragments have surfaced, 
              and a man named Demas — a scholar tied to a ministry 
              more interested in wealth than worship — has been tracking them. 
              He is one move behind you. 
              You know what faithful stewardship looks like.
              Hananiah believed someone like you would come. 
              So find the treasure, and steward it well.
